...
namespace Dominion.Utility.DataGeneration
{
    ...
    ///     I, JAY BARTHOLAMULE JOHNSON, STOLE THIS FROM: Dominion.Web.Areas.ApiDocs.ObjectGenerator
    ///     It builds randomish data for objects so I used it for testing dto-entity and entity-dto mapping since
    ///     I was only interested in the object having data and not any real meaningful test data.
    ///     This class does a good job at setting up anoying data for testing.
    ///     As long as it doesn't break any other tests then modify it how ever you please.
    /// </summary>
    public class ObjectGenerator
    {
            ...
            where T : class
        {
            ...
            var obj = (T)objectGenerator.GenerateObject(typeof(T));
            return obj;
        }
        ...
        [SuppressMessage("StyleCop.CSharp.NamingRules", "SA1306:FieldNamesMustBeginWithLowerCaseLetter", 
            Justification = "Reviewed. Suppression is OK here.")] private readonly SimpleTypeObjectGenerator
            SimpleObjectGenerator = new SimpleTypeObjectGenerator();

        public static ObjectGenerator GlobalGenerator
        {
            get { return new ObjectGenerator(); }
        }
        ...
        /// <summary>
        ///     Generates a collection of objects of the given type.
        /// </summary>
        /// <typeparam name="T">Type of object to create collection of.</typeparam>
        /// <param name="numberToCreate">Number of objects to include in the collection.</param>
        /// <returns>Collection of generated objects of the given type.</returns>
        public IEnumerable<T> GenerateObjectCollection<T>(int numberToCreate)
        {
            return
                (IEnumerable<T>)
                    GenerateGenericType(typeof(IEnumerable<T>), numberToCreate, new Dictionary<Type, object>());
        }
        ...
        private static object GenerateEnum(
            Type enumType)
        {
