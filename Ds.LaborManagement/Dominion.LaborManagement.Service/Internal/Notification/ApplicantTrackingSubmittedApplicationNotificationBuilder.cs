...
{
    public class ApplicantTrackingSubmittedApplicationNotificationBuilder : INotificationBuilder
    {
        ...
        private readonly string _smsText;
        ...
        NotificationType INotificationBuilder.NotificationType =>
            NotificationType.SubmittedApplication;

        string INotificationBuilder.NotificationDetails => GetNotificationDetails();
        

        public ApplicantTrackingSubmittedApplicationNotificationBuilder(IBusinessApiSession session, ApplicantDetailDto applicant, int? correspondenceId,
            string correspondenceSubject, string correspondenceBody, ApplicantTrackingCorrespondenceReplacementInfoDto replacementInfo, IClientService clientService, string smsText)
        {
            _session = session;
        ...
        {
            var message = new StringBuilder(_smsText);
            var mainLink = ConfigurationManager.AppSettings.Get("MainRedirectRootUrl");
