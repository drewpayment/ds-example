...
namespace Dominion.Domain.Entities.Employee
{
    ...
    public partial class EmployeeDeduction : Entity<EmployeeDeduction>, IHasModifiedOptionalData
    {
        ...
        public virtual EmployeeDeductionAmountTypeInfo DeductionAmountTypeInfo { get; set; }
