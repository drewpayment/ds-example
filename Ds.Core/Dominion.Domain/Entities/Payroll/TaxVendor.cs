...
{
    public partial class TaxVendor
    {
        ...
        public virtual string   AchCodePayroll   { get; set; }
        public virtual string   AchCodeMonthly   { get; set; }
        public virtual string   AchCodeQuarterly { get; set; }
