...
import { IEmployeeBirthdate } from '@ds/analytics';
...
@Component({
  selector: 'ds-birthday-event-dialog',
  templateUrl: './birthday-event-dialog.component.html',
  styleUrls: ['./birthday-event-dialog.component.css']
})
export class BirthdayEventDialogComponent implements OnInit {

  dataSource: MatTableDataSource<IEmployeeBirthdate>;
  displayedColumns: string[] = ['Name', 'Department', 'Cost Center', 'Birthdate', 'Age'];

  @ViewChild(MatPaginator, { static: true }) paginator: MatPaginator;
  @ViewChild(MatSort, { static: true }) sort: MatSort;

  constructor(@Inject(MAT_DIALOG_DATA) public data: any, public dialogRef: MatDialogRef<BirthdayEventDialogComponent>) { }
  ...
  ngOnInit() {
    this.dataSource = new MatTableDataSource<IEmployeeBirthdate>(this.data.employeeBirthdates);
  ...
  print = () => {
    var employees = this.data.employeeBirthdates;
