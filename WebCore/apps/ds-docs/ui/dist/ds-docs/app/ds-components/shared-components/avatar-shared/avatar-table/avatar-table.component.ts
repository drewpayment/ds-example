...
@Component({
  selector: 'ds-avatar-table',
  templateUrl: './avatar-table.component.html',
  styleUrls: ['./avatar-table.component.scss']
})
export class AvatarTableComponent implements OnInit, AfterViewInit  {

  displayedColumns: string[] = ['selected', 'avatar', 'character', 'movie', 'year'];
