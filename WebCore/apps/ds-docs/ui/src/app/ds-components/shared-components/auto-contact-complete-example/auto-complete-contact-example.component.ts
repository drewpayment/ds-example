...
import { of } from 'rxjs';
import { DEMO_CONTACTS } from '@ds/docs/ds-components/shared/contacts';

@Component({
  selector: 'ds-auto-complete-contact-example',
  templateUrl: './auto-complete-contact-example.component.html',
  styleUrls: ['./auto-complete-contact-example.component.scss']
})
export class AutoCompleteContactExampleComponent implements OnInit {
